        ...
        <div
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
                    ...
                    <div className='hidden lg:block fixed left-0 top-0 h-full  bg-gray-800 z-30 transform transition-transform duration-300 ease-in-out'>
                        ...
                        <ul>
                            <li
                                className={`mb-5 text-white p-2 px-6 ${!isBundles ? 'bg-green-500 ' : ''
                                    }`}>
                                <button
                            ...
                            <li
                                className={`mb-10 text-white p-2 px-6 ${isBundles ? 'bg-green-500' : ''
                                    }`}>
                                <button
                    ...
                    <div className='hidden md:block lg:hidden sticky top-0 z-20 bg-gray-800 py-2 mb-4'>
                        <div className='flex justify-center space-x-2'>
                            <button
                                className={`px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 ${!isBundles
