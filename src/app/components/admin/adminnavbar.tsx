							...
							<div className='flex flex-1 items-center justify-center sm:items-stretch sm:justify-start'>
								<div className='hidden sm:ml-6 sm:flex sm:space-x-8'>
									...
									<a
										...
										className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium ${
											currentPage === '/admin/add-activities-and-coaches'
												? 'text-white border-indigo-500'
												: 'text-gray-500 border-transparent'
										} `}>
									...
									<a
										...
										className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium ${
											currentPage === '/admin/view-reservations'
												? 'text-white border-indigo-500'
												: 'text-gray-500 border-transparent'
										} `}>
										View reservations
									...
									<a
										...
										className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium ${
											currentPage === '/admin/add-timeslots'
												? 'text-white border-indigo-500'
												: 'text-gray-500 border-transparent'
										} `}>
										Add time slots
									...
									<a
										href='/admin/add-market-items'
										className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium ${
											currentPage === '/admin/add-market-items'
												? 'text-white border-indigo-500'
												: 'text-gray-500 border-transparent'
										} `}>
										Manage Items
									...
									<a
										...
										className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium ${
											currentPage === '/admin/book-for-client'
												? 'text-white border-indigo-500'
												: 'text-gray-500 border-transparent'
										} `}>
										Book for client
