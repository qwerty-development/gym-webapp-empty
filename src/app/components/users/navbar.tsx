        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div className="relative flex h-20  justify-between">
              ...
              <div className="flex lg:hidden md:hidden items-center justify-center sm:items-stretch sm:justify-start flex-1"> {/* Centering logo horizontally */}
                  <a href="/" className="flex items-center">
                    <img src="/images/logoinverted.png" alt="Logo" className="h-10 w-auto" />
                  </a>
                </div>

                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                <div className="flex items-center justify-center sm:items-stretch sm:justify-start flex-1"> {/* Centering logo horizontally */}
                  <a href="/" className="flex items-center">
                    <img src="/images/logoinverted.png" alt="Logo" className="h-10 w-auto" />
                  </a>
                </div>
